...
export default function PrivacyPage() {
  return (
    <div className="container" style={{ padding: '32px 16px 56px', maxWidth: 720 }}>
      ...
      <p style={{ color: '#6B7684', fontSize: 13 }}>Last updated: 23 July 2026</p>
      ...
      <div className="card" style={{ lineHeight: 1.7, fontSize: 14.5 }}>
        ...
        <p>
          ...
          any time. To request deletion, email <a href="mailto:privacy@openbaseafrica.com">privacy@openbaseafrica.com</a>{' '}
          with the email address you applied with — we will confirm deletion within a
